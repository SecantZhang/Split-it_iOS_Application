...
//  Split-it
//
//  Created by Wilson Zhang on 6/12/18.
...
//        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "HistUserItemCell", for: indexPath)
        cell.textLabel?.text = "User Name: \(userAry[indexPath.row])"
